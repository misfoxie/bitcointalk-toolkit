...
const MODULE_DEFS = [
  ...
  { id:'trustPositionBadge', name:'Trust Position Badge',   category:'User/Profile Tools', description:'Shows DT badges beside post authors from cached Bitcointalk DT data.', kind:'content', modulePath:'../modules/trustPositionBadge.js', defaultEnabled:true },
